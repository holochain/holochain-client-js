...
### Changed
- Release for Holochain v0.6.2-rc.0.

### Added

- Added `InitProperties` type and `init_properties` optional field to `RoleSettings` provisioned variant, reflecting the new DNA migration feature in Holochain v0.6.2-rc.0.
